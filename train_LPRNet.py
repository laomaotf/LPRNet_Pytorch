...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default=r"D:\dataset\lpr\ocr\train", help='the train images path')
    ...
    parser.add_argument('--lr_schedule', default=[20, 100, 130], help='schedule for learning rate.')
...
def train():
    ...
    train_dataset = LPRDataLoader(train_img_dirs.split(','), args.img_size, args.lpr_max_len,flag_train=True)
